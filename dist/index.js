...
const TODO_PATTERN = /\sTODO\s?(?:\[(\d{4}-\d{2}-\d{2})\])?:(.*)$/;
...
const getBlame = (file, line) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        commit,
        author,
        date: new Date(parseInt(timestamp, 10) * 1000).toLocaleDateString('en-CA')
    };
});
// TODO [2021-10-10]: Add tests
const getAllTodoCommentLines = () => __awaiter(void 0, void 0, void 0, function* () {
    const { stdout } = yield execAsync("git grep -I -n -P '\\sTODO\\s?(\\[.*?\\])?:'");
    return stdout
        .trim()
        .split('\n')
        .map(lineText => {
        ...
        if (!(0, utils_1.isComment)(file, text))
            return;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const todoCommentLines = yield getAllTodoCommentLines();
            const promises = todoCommentLines.map(({ file, line, text }) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!todoComment)
                    return;
                return Object.assign({ file, line, blame }, todoComment);
            }));
...
const commentPattern = __importStar(__nccwpck_require__(278));
...
function __ncc_wildcard$0 (arg) {
  if (arg === "handlebars.js" || arg === "handlebars") return __nccwpck_require__(363);
  else if (arg === "javascript.js" || arg === "javascript") return __nccwpck_require__(546);
}
var path = __nccwpck_require__(17)
var _ = __nccwpck_require__(801)
var byMatcher = __nccwpck_require__(933)
...
function commentPattern (filename) {
  var base = __nccwpck_require__(481)
...
commentPattern.regex = function commentRegex (filename) {
  var regex = __nccwpck_require__(902)
...
commentPattern.codeContext = function codeContext (filename) {
  ...
  return __ncc_wildcard$0(langFile)
}
...
var Detector = __nccwpck_require__(910)
...
module.exports = eval("require")("parse-code-context");
